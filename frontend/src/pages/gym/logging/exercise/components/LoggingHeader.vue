...
<template>
    <div class="grid w-full grid-cols-[auto_1fr_auto] items-center gap-2 border-b border-zinc-700 pb-2 box-border">
        <button
        ...
        <div class="min-w-0 text-center">
            ...
            <h2 v-else-if="title" class="m-0 truncate text-lg font-medium">{{ title }}</h2>
        </div>
